export default function Practices() {
    return (
        <div className="container-fiuld pt-5 px-3 pr-0">
            <div className="row justify-content-center">
                <div className="col-12">
                    <h1>Our Main Practices</h1>
                </div>
            </div>
            ...
            <div className="row mt-5">
                ...
                <div className="col-sm-10">
                    <div className="row ">
                        <div className="col-sm-4 py-5" style={{ background: "#E8D1AE" }}>
                            <div>
                                <h3>General Counsel</h3>
                                <hr />
                                <p>
                                    Our attorneys work closely with our clients to understand their unique needs, objectives,
                                    and challenges, and provide tailored legal solutions that align with their business goals.
                                    We offer a wide range of general counsel services, including contract drafting and review,
                                    corporate governance, risk management, compliance, and employment law matters.
                                </p>
                            </div>
                        </div>
                        <div className="col-sm-4 py-5" style={{ background: "#DBBF94" }}>
                            <div>
                        ...
                        <div className="col-sm-4 py-5" style={{ background: "#CDAD7D" }}>
                            <div>
