        ...
        <div className="container-fluid py-5">
            <div className="row justify-content-center">
                <div className="col-md-9">
                        ...
                        <div className="col-sm-6 my-4">
                            <div className="m-2 text-center">
                                <div className="triangle-container">
                                    <div className="img">
                                        <img src="/about1.png" alt="about" width={400} />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-sm-6 mt-5 primary">
                            <div className="m-2">
                                ...
                                <p>
                                    ...
                                    the financial stress associated with a personal injury.
                                </p>

                                <p>
                                    We only charge you lawyer&lsquo;s fees if we recover compensation for you. We have staffs who fluently
                                    speaks many languages and can interpret for you if you are more comfortable with your native language.
                                </p>

                                <p>
                                    Our mission is to recover the highest damages possible in your claim and to make the process as
                                    smooth and stress-free as we can. We truly care about your case and your personal well-being, a
                                    fact that is obvious from our emphasis on customer service.
                                </p>
                        ...
                        <div className="col-sm-6 mt-4">
                            <div className="m-2 text-center">
                                <div className="triangle-container">
                                    <div className="img">
                                        <img src="/about2.png" alt="about" width={400} />
                                    </div>
                                </div>
                            </div>
                        </div>
